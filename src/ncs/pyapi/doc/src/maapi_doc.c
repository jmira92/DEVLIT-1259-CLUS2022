...
"* sock -- a python socket instance\n"
"* thandle -- transaction handle\n"
"* flags -- Normally the flags parameter should be given as 0, but there is a\n"
"    deprecated flag that enables to suppress the creation of backpointer\n"
"    attributes by passing the SHARED_NO_BACKPOINTER for flags.\n");
