...
public class InetAddressRangeSet {
    ...
    /*
      ...
      public asSubnetSet() returns set of Subnet

      constructor takes set of InetAddressRange

      Constructor takes set of Subnet
                                       ...
                                       InclusiveSubnet subnet)
    {
        ...
        if (lowestRange.containsAll(rangeToRemove)) {
            ...
            try {
                ...
                System.err.println("InvalidNetmaskException: "+e);
            }
