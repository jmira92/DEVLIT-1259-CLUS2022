...
public class IdAllocator implements ApplicationComponent {
    private static Logger LOGGER = LogManager.getLogger(IdAllocator.class);
    ...
    private void loadState() throws NavuException, ConfException,
            UnknownHostException, InvalidRangeException, IOException {
    ...
    private void createPool(NavuContainer pool)
        ...
        NavuContainer poolRange =
            pool.namespace(idAllocator.id).container(idAllocator._range_);
        ...
        NavuList poolExclude = pool.namespace(idAllocator.id)
                .list(idAllocator._exclude_);
