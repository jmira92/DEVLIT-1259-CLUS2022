...
public class l3vpnRFS {
    ...
    @ServiceCallback(servicePoint="l3vpn-servicepoint",
        ...
        Template qosPePrioTemplate = new Template(context, "l3vpn-qos-pe-prio");
        Template aclTemplate = new Template(context, "l3vpn-acl");
        Template classTemplate = new Template(context, "l3vpn-qos-class");
        Template peClassTemplate = new Template(context, "l3vpn-qos-pe-class");
        ...
        for(NavuContainer endpoint : endpoints.elements()) {
            try {
                ...
                NavuContainer conn = getConnection(topology,
                                                   ...
                                                   valueAsString());
                System.out.println("XXXX conn for " + ceName + " = " + conn);
