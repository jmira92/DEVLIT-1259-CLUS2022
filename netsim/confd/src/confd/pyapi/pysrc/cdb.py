...
class Subscriber(threading.Thread):
    ...
    * should_post_iterate(state) (optional)
    ...
    def __init__(self, app=None, log=None, host='127.0.0.1', port=_tm.PORT,
    ...
    def _read_sub_socket(self):
        ...
        for point in points:
            ...
            # In some cases (e.g. HA slave) it's desirable to be able
            # skip calling diff_iterate
...
class TwoPhaseSubscriber(Subscriber):
    ...
    * abort(kp, op, oldv, newv, state) (mandatory)
    ...
    def __init__(self, name, app=None, log=None, host='127.0.0.1',
                 port=_tm.PORT):
