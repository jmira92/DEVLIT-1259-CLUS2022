...
def connect(ip='127.0.0.1', port=_tm.PORT, path=None):
    """
...
def single_read_trans(user, context, groups=[],
                      db=_tm.RUNNING, ip='127.0.0.1',
                      port=_tm.PORT, path=None, src_ip='127.0.0.1',
...
class Maapi(object):
    ...
    def __init__(self, ip='127.0.0.1', port=_tm.PORT, path=None,
                 load_schemas=True, msock=None):
    ...
    # convenience
    def start_user_session(self, user, context, groups=[], src_ip='127.0.0.1',
                           src_port=0, proto=_tm.PROTO_TCP, vendor=None,
                           product=None, version=None, client_id=None):
...
class Session(object):
    ...
    def __init__(self, maapi, user, context, groups=[], src_ip='127.0.0.1',
