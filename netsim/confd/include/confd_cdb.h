...
#define CDB_GET_MODS_CLI_NO_BACKQUOTES    (1 << 3)
#define CDB_GET_MODS_INCLUDE_MOVES        (1 << 4)
#define CDB_GET_MODS_WANT_ANCESTOR_DELETE (1 << 5)
...
extern int cdb_get_values(int sock, confd_tag_value_t *values, int n,
                          const char *fmt, ...);
extern int cdb_get_attrs(int sock, u_int32_t *attrs, int num_attrs,
                         confd_attr_value_t **attr_vals, int *num_vals,
                         const char *fmt, ...);

extern int cdb_set_attr(int sock, u_int32_t attr, confd_value_t *v,
                        const char *fmt, ...);
...
extern int cdb_set_values(int sock, const confd_tag_value_t *values, int n,
                          const char *fmt, ...);
extern struct confd_cs_node *cdb_cs_node_cd(int sock, const char *fmt, ...);
...
extern int cdb_vset_values(int sock, const confd_tag_value_t *values, int n,
                           const char *fmt, va_list args);
extern int cdb_vset_attr(int sock, u_int32_t attr, confd_value_t *v,
                         const char *fmt, va_list args);
extern int cdb_vget_attrs(int sock, u_int32_t *attrs, int num_attrs,
                         confd_attr_value_t **attr_vals, int *num_vals,
                         const char *fmt, va_list args);
extern struct confd_cs_node *cdb_vcs_node_cd(int sock,
                                             const char *fmt, va_list args);
