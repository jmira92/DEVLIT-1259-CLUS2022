...
get_logsym(?LOGSYM_RESERVED_99) -> {"RESERVED_99","RESERVED_99"};
get_logsym(?LOGSYM_RESERVED_100) -> {"RESERVED_100","RESERVED_100"};
get_logsym(?LOGSYM_RESERVED_101) -> {"RESERVED_101","RESERVED_101"};
get_logsym(?LOGSYM_RESERVED_102) -> {"RESERVED_102","RESERVED_102"};
get_logsym(?LOGSYM_RESERVED_103) -> {"RESERVED_103","RESERVED_103"};
get_logsym(?LOGSYM_RESERVED_104) -> {"RESERVED_104","RESERVED_104"};
...
get_logsym(?LOGSYM_RESERVED_108) -> {"RESERVED_108","RESERVED_108"};
get_logsym(?LOGSYM_RESERVED_109) -> {"RESERVED_109","RESERVED_109"};
...
get_logsym(?LOGSYM_STARTING) -> {"STARTING","ConfD is starting."};
...
get_logsym(?LOGSYM_MISSING_AES256CFB128_SETTINGS) -> {"MISSING_AES256CFB128_SETTINGS","AES256CFB128 keys were not found in confd.conf"};
...
get_logsym(?LOGSYM_CONFIG_CHANGE) -> {"CONFIG_CHANGE","A change to ConfD configuration has taken place, e.g., by a reload of the configuration file"};
