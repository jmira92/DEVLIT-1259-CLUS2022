...
-mask_def_start('CONFD_PROTO_DATA_CB').
...
-define(MASK_DATA_WANT_FILTER,      (1 bsl 17)).
-mask_def_stop('CONFD_PROTO_DATA_CB').
...
-define(CONFD_PROTO_PUSH_ON_CHANGE_CB,          141).
...
-mask_def_start('CONFD_PROTO_ACTION_CB').
...
-mask_def_stop('CONFD_PROTO_ACTION_CB').
...
-mask_def_start('CONFD_PROTO_AUTHORIZATION_CB').
-define(MASK_CHK_CMD_ACCESS,              (1 bsl 0)).
-define(MASK_CHK_DATA_ACCESS,             (1 bsl 1)).
-mask_def_stop('CONFD_PROTO_AUTHORIZATION_CB').
...
-define(CONFD_ACCESS_CHK_DESCENDANT,      (1 bsl 10)).
...
%% This macro is deprecated, and only present for temporary backward
...
-mask_def_start('CONFD_PROTO_SERVICE_CB').
...
-mask_def_stop('CONFD_PROTO_SERVICE_CB').

%%- flags for NCS service callbacks
-mask_def_start('CONFD_PROTO_NANO_SERVICE_CB').
-define(MASK_NANO_SERVICE_CREATE,         (1 bsl 0)).
-define(MASK_NANO_SERVICE_DELETE,         (1 bsl 1)).
-mask_def_stop('CONFD_PROTO_NANO_SERVICE_CB').
...
%%- yang-push callbacks
-define(CONFD_PROTO_SUBSCRIBE_ON_CHANGE,        220).
-define(CONFD_PROTO_UNSUBSCRIBE_ON_CHANGE,      221).
%%- yang-push requests
-define(CONFD_PROTO_PUSH_ON_CHANGE,             230).

%%- COMMON END

%% keep in sync with confd_lib.h.in enum confd_dbname
-define(CONFD_PROTO_NO_DB,       0).
